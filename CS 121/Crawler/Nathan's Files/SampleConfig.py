...
class SampleConfig(Config):
    ...
    def ValidUrl(self, url):
        ...
        parsed = urlparse(url)
        try:
            if "calendar.ics.uci.edu" in url or "duttgroup" in url or "evoke.ics.uci.edu/?p=" in url or "#respond#respond#respond" in url or "archive.uci.edu" in url:
                print "ValidURL = False URL = " + url
                return False
